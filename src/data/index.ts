...
export const toolCategories: ToolCategory[] = [
  { id: 'chat', name: 'AI对话', icon: '💬', count: 33 },
  { id: 'image', name: 'AI绘图', icon: '🎨', count: 27 },
  { id: 'video', name: 'AI视频', icon: '🎬', count: 20 },
  { id: 'code', name: 'AI编程', icon: '💻', count: 24 },
  { id: 'writing', name: 'AI写作', icon: '✍️', count: 21 },
  { id: 'audio', name: 'AI音频', icon: '🎵', count: 15 },
  { id: 'productivity', name: '效率工具', icon: '⚡', count: 29 },
...
export const tools: Tool[] = [
  // ===== AI对话 =====
  {
    ...
    pricing: 'freemium', rating: 4.8, reviewCount: 12580, featured: true, hot: true, isNew: false,
  ...
  },
  {
    ...
    url: 'https://claude.ai',
    pricing: 'freemium', rating: 4.7, reviewCount: 6800, featured: false, hot: true, isNew: false,
  ...
  },
  {
    ...
    pricing: 'freemium', rating: 4.6, reviewCount: 4500, featured: false, hot: false, isNew: false,
  ...
  },
  {
    ...
    pricing: 'free', rating: 4.7, reviewCount: 9200, featured: true, hot: true, isNew: false,
  ...
  },
  {
    ...
    pricing: 'free', rating: 4.5, reviewCount: 7100, featured: false, hot: true, isNew: false,
  ...
  },
  {
    ...
    pricing: 'free', rating: 4.4, reviewCount: 8800, featured: true, hot: true, isNew: false,
  ...
  },
  {
    ...
    pricing: 'freemium', rating: 4.5, reviewCount: 5200, featured: true, hot: true, isNew: true,
  ...
  },
  {
    ...
    pricing: 'freemium', rating: 4.3, reviewCount: 3400, featured: true, hot: false, isNew: false,
  ...
  },
  {
    ...
    pricing: 'free', rating: 4.5, reviewCount: 4800, featured: true, hot: true, isNew: true,
  ...
  },
  {
    ...
    pricing: 'freemium', rating: 4.4, reviewCount: 3600, featured: true, hot: true, isNew: true,
  ...
  },
  {
    ...
    pricing: 'freemium', rating: 4.5, reviewCount: 5600, featured: false, hot: false, isNew: false,
  ...
  // ===== AI绘图 =====
  {
    ...
    pricing: 'paid', rating: 4.9, reviewCount: 8920, featured: true, hot: true, isNew: false,
  ...
  },
  {
    ...
    pricing: 'freemium', rating: 4.6, reviewCount: 6400, featured: true, hot: false, isNew: false,
  ...
  },
  {
    ...
    pricing: 'free', rating: 4.5, reviewCount: 11200, featured: false, hot: true, isNew: false,
  ...
  },
  {
    ...
    pricing: 'freemium', rating: 4.6, reviewCount: 9800, featured: false, hot: false, isNew: false,
  ...
  },
  {
    ...
    pricing: 'freemium', rating: 4.7, reviewCount: 7500, featured: false, hot: false, isNew: true,
  ...
  // ===== AI视频 =====
  {
    ...
    url: 'https://sora.com',
    pricing: 'paid', rating: 4.6, reviewCount: 2100, featured: true, hot: true, isNew: true,
    publishedAt: '2025-02-01',
  ...
  },
  {
    ...
    pricing: 'freemium', rating: 4.5, reviewCount: 3200, featured: false, hot: true, isNew: false,
    publishedAt: '2025-01-15',
  ...
  },
  {
    ...
    pricing: 'freemium', rating: 4.4, reviewCount: 4800, featured: false, hot: true, isNew: true,
  ...
  },
  {
    ...
    pricing: 'freemium', rating: 4.3, reviewCount: 1800, featured: false, hot: false, isNew: true,
  ...
  // ===== AI编程 =====
  {
    ...
    url: 'https://cursor.sh',
    pricing: 'freemium', rating: 4.7, reviewCount: 5340, featured: true, hot: true, isNew: false,
    publishedAt: '2025-01-10',
  ...
  },
  {
    ...
    pricing: 'paid', rating: 4.6, reviewCount: 15600, featured: true, hot: false, isNew: false,
  ...
  },
  {
    ...
    url: 'https://v0.dev',
    pricing: 'freemium', rating: 4.5, reviewCount: 3200, featured: false, hot: true, isNew: true,
  ...
  },
  {
    ...
    url: 'https://bolt.new',
    pricing: 'freemium', rating: 4.4, reviewCount: 2800, featured: false, hot: true, isNew: true,
  ...
  },
  {
    ...
    pricing: 'free', rating: 4.8, reviewCount: 8900, featured: false, hot: false, isNew: false,
  ...
  },
  {
    ...
    pricing: 'freemium', rating: 4.3, reviewCount: 2100, featured: false, hot: false, isNew: false,
  ...
  // ===== AI写作 =====
  {
    ...
    pricing: 'freemium', rating: 4.6, reviewCount: 18200, featured: false, hot: false, isNew: false,
  ...
  },
  {
    ...
    pricing: 'paid', rating: 4.4, reviewCount: 5600, featured: false, hot: false, isNew: false,
  ...
  // ===== AI音频 =====
  {
    ...
    pricing: 'freemium', rating: 4.8, reviewCount: 3800, featured: false, hot: false, isNew: false,
  ...
  },
  {
    ...
    url: 'https://suno.com',
    pricing: 'freemium', rating: 4.7, reviewCount: 7200, featured: true, hot: true, isNew: true,
  ...
  },
  {
    ...
    pricing: 'freemium', rating: 4.5, reviewCount: 2400, featured: false, hot: false, isNew: false,
  ...
  // ===== 效率工具 =====
  {
    ...
    pricing: 'freemium', rating: 4.7, reviewCount: 13500, featured: true, hot: false, isNew: false,
    publishedAt: '2025-01-03',
  ...
  },
  {
    ...
    url: 'https://gamma.app',
    pricing: 'freemium', rating: 4.4, reviewCount: 3600, featured: false, hot: true, isNew: true,
  ...
  // ===== 技术社区 =====
  {
    ...
    pricing: 'free', rating: 4.5, reviewCount: 22400, featured: true, hot: false, isNew: false,
    publishedAt: '2025-01-01',
  ...
  // ===== AI对话 - 新增 =====
  {
    id: '50', name: '文心一言', slug: 'wenxin',
    description: '百度推出的大语言模型助手，中文理解能力顶尖，支持文本生成、图像创作、代码编写等全面能力。',
    longDescription: '文心一言是百度基于文心大模型推出的AI助手，在中文理解、文本创作和知识问答方面表现优秀。深度整合百度搜索生态，支持文本生成、图片创作、代码编写等多种功能。',
    category: 'chat', tags: ['对话', '中文', '百度', '文心'],
    url: 'https://yiyan.baidu.com',
    pricing: 'freemium', rating: 4.3, reviewCount: 6200, featured: false, hot: true, isNew: false,
    publishedAt: '2025-01-20',
    pros: ['中文理解强', '百度生态整合', '多模态支持'],
    cons: ['英文能力一般', '创意性稍弱'],
  },
  {
    id: '51', name: '通义千问', slug: 'tongyi',
    description: '阿里云推出的大语言模型，中文表现优异，支持多模态，免费使用，深度整合阿里生态。',
    longDescription: '通义千问是阿里巴巴达摩院推出的大语言模型，在中文理解、代码生成和数学推理方面表现出色。完全免费使用，支持长文本处理和多模态理解，与阿里云生态深度整合。',
    category: 'chat', tags: ['对话', '中文', '阿里', '开源'],
    url: 'https://tongyi.aliyun.com',
    pricing: 'free', rating: 4.4, reviewCount: 5800, featured: false, hot: true, isNew: false,
    publishedAt: '2025-02-05',
    pros: ['完全免费', '中文理解好', '开源版本可用'],
    cons: ['长上下文稍弱', '生态不如ChatGPT'],
  },
  {
    id: '52', name: '讯飞星火', slug: 'xinghuo',
    description: '科大讯飞推出的大语言模型，语音交互能力业界领先，中文写作和教育场景表现出色。',
    longDescription: '讯飞星火是科大讯飞基于自研大模型推出的AI助手，依托科大讯飞在语音技术领域的深厚积累，语音交互能力业界领先。在中文写作、教育辅导和办公场景中表现优异。',
    category: 'chat', tags: ['对话', '语音', '中文', '教育'],
    url: 'https://xinghuo.xfyun.cn',
    pricing: 'freemium', rating: 4.2, reviewCount: 4500, featured: false, hot: false, isNew: false,
    publishedAt: '2025-01-22',
    pros: ['语音交互强', '教育场景好', '中文写作优秀'],
    cons: ['通用能力稍弱', '复杂推理一般'],
  },
  {
    id: '53', name: '秘塔写作猫', slug: 'metaso',
    description: '专注中文写作的AI助手，语法纠错、润色改写、公文写作能力突出，中文写作必备。',
    longDescription: '秘塔写作猫是专注于中文写作场景的AI助手，在语法纠错、文本润色和公文写作方面具有明显优势。支持多种写作模式，是中文写作和内容创作者的得力工具。',
    category: 'chat', tags: ['写作', '中文', '纠错', '润色'],
    url: 'https://xiezuocat.com',
    pricing: 'freemium', rating: 4.3, reviewCount: 3800, featured: false, hot: false, isNew: false,
    publishedAt: '2025-02-10',
    pros: ['中文润色优秀', '公文写作强', '语法纠错准确'],
    cons: ['仅限中文', '创意写作一般'],
  },
  {
    id: '54', name: '腾讯元宝', slug: 'yuanbao',
    description: '腾讯推出的AI助手，深度整合微信生态，中文对话体验流畅，支持多模态输入。',
    longDescription: '腾讯元宝是腾讯推出的AI助手，基于混元大模型打造，深度整合微信、QQ等腾讯生态。支持文字、图片、语音等多模态输入，中文对话体验流畅自然。',
    category: 'chat', tags: ['对话', '中文', '腾讯', '多模态'],
    url: 'https://yuanbao.tencent.com',
    pricing: 'free', rating: 4.1, reviewCount: 3200, featured: false, hot: false, isNew: true,
    publishedAt: '2025-03-20',
    pros: ['微信生态联动', '完全免费', '多模态支持'],
    cons: ['功能相对基础', '独立能力一般'],
  },

  // ===== AI绘图 - 新增 =====
  {
    id: '55', name: 'Leonardo AI', slug: 'leonardo',
    description: '专业AI图像生成平台，游戏资产、角色设计、概念艺术首选，免费额度大方。',
    longDescription: 'Leonardo AI 是专业的AI图像生成平台，特别擅长游戏资产、角色设计和概念艺术创作。提供丰富的风格模型和参数调节选项，免费额度大方，是设计师和游戏开发者的首选工具之一。',
    category: 'image', tags: ['绘图', '游戏', '角色设计', '概念艺术'],
    url: 'https://leonardo.ai',
    pricing: 'freemium', rating: 4.5, reviewCount: 5600, featured: false, hot: true, isNew: false,
    publishedAt: '2025-01-18',
    pros: ['游戏资产生成强', '免费额度大方', '模型丰富'],
    cons: ['中文提示词一般', '高质量需付费'],
  },
  {
    id: '56', name: 'Ideogram', slug: 'ideogram',
    description: 'AI文生图新锐，文字渲染能力业界顶级，适合海报设计、Logo生成、品牌视觉。',
    longDescription: 'Ideogram 是AI图像生成领域的新锐力量，最大的优势是在图像中准确渲染文字，这在AI绘图领域极为稀缺。非常适合海报设计、Logo生成和品牌视觉创作，文字清晰可读。',
    category: 'image', tags: ['绘图', '文字渲染', '设计', '海报'],
    url: 'https://ideogram.ai',
    pricing: 'freemium', rating: 4.4, reviewCount: 3200, featured: false, hot: true, isNew: true,
    publishedAt: '2025-03-05',
    pros: ['文字渲染顶级', '海报设计强', '免费可用'],
    cons: ['风格选择有限', '生成速度一般'],
  },
  {
    id: '57', name: '通义万相', slug: 'wanxiang',
    description: '阿里推出的AI绘画平台，中文提示词友好，支持文生图、图生图、涂鸦生图多种模式。',
    longDescription: '通义万相是阿里巴巴推出的AI绘画平台，对中文提示词理解友好，支持文生图、图生图、涂鸦生图等多种创作模式。在中文场景下的图像生成效果优秀，免费使用。',
    category: 'image', tags: ['绘图', '中文', '阿里', '免费'],
    url: 'https://tongyi.aliyun.com/wanxiang',
    pricing: 'free', rating: 4.2, reviewCount: 2800, featured: false, hot: false, isNew: false,
    publishedAt: '2025-02-15',
    pros: ['中文提示词友好', '完全免费', '多模式创作'],
    cons: ['画质不如MJ', '风格有限'],
  },

  // ===== AI视频 - 新增 =====
  {
    id: '58', name: '即梦AI', slug: 'jimeng-video',
    description: '字节跳动剪映旗下AI视频生成工具，文生视频效果惊艳，中文提示词友好，操作简单。',
    longDescription: '即梦AI是字节跳动剪映旗下的AI视频生成工具，核心提供文生视频功能。依托自研模型，中文提示词理解极好，与剪映生态无缝协同，是国产AI视频的佼佼者。',
    category: 'video', tags: ['视频生成', '中文', '字节', '剪映'],
    url: 'https://jimeng.jianying.com/ai-tool/video/generate',
    pricing: 'freemium', rating: 4.3, reviewCount: 4200, featured: false, hot: true, isNew: true,
    publishedAt: '2025-03-10',
    pros: ['中文友好', '剪映联动', '操作简单'],
    cons: ['时长有限', '模板不多'],
  },
  {
    id: '59', name: 'Pika', slug: 'pika',
    description: 'AI视频生成新秀，支持文生视频和图生视频，效果自然流畅，创意视频制作首选。',
    longDescription: 'Pika 是AI视频生成领域的新秀，支持文字生成视频和图片生成视频两种模式。生成的视频效果自然流畅，特别适合创意短视频制作和社交媒体内容创作。',
    category: 'video', tags: ['视频生成', '创意', '短视频'],
    url: 'https://pika.art',
    pricing: 'freemium', rating: 4.3, reviewCount: 3500, featured: false, hot: true, isNew: true,
    publishedAt: '2025-02-20',
    pros: ['效果自然流畅', '操作简单', '免费额度'],
    cons: ['视频时长短', '高质量需付费'],
  },

  // ===== AI编程 - 新增 =====
  {
    id: '60', name: 'Windsurf', slug: 'windsurf',
    description: 'Codeium推出的AI编程IDE，深度集成AI对话与代码生成，支持多文件编辑，免费使用。',
    longDescription: 'Windsurf 是Codeium推出的AI编程IDE，以Cascade AI Flow为核心，深度集成AI对话与代码生成能力。支持多文件协同编辑、上下文感知的智能补全，提供慷慨的免费额度。',
    category: 'code', tags: ['编程', 'IDE', '代码生成', '免费'],
    url: 'https://codeium.com/windsurf',
    pricing: 'freemium', rating: 4.4, reviewCount: 4200, featured: false, hot: true, isNew: true,
    publishedAt: '2025-03-01',
    pros: ['免费额度大方', '多文件编辑', 'Cascade Flow'],
    cons: ['社区不如Cursor', '插件生态有限'],
  },
  {
    id: '61', name: 'Replit AI', slug: 'replit',
    description: '在线AI编程平台，浏览器内直接开发部署全栈应用，支持多种语言，零配置开箱即用。',
    longDescription: 'Replit AI 是强大的在线编程平台，内置AI辅助编程功能。用户可以在浏览器中直接开发、运行和部署全栈应用，支持Python、JavaScript等数十种语言，零配置开箱即用。',
    category: 'code', tags: ['编程', '在线IDE', '部署', '全栈'],
    url: 'https://replit.com',
    pricing: 'freemium', rating: 4.3, reviewCount: 5800, featured: false, hot: false, isNew: false,
    publishedAt: '2025-01-15',
    pros: ['零配置部署', '多语言支持', '协作方便'],
    cons: ['性能依赖网络', '大项目支持有限'],
  },

  // ===== AI写作 - 新增 =====
  {
    id: '62', name: '秘塔写作猫', slug: 'xiezuocat',
    description: '专注中文写作的AI助手，语法纠错精准，润色改写自然，公文写作首选。',
    longDescription: '秘塔写作猫是专为中文写作设计的AI助手，在语法纠错、文本润色和公文写作方面具有明显优势。提供多种写作模式和风格选择，是中文内容创作者的得力工具。',
    category: 'writing', tags: ['写作', '中文', '纠错', '润色'],
    url: 'https://xiezuocat.com',
    pricing: 'freemium', rating: 4.3, reviewCount: 3800, featured: false, hot: false, isNew: false,
    publishedAt: '2025-02-08',
    pros: ['中文纠错精准', '润色自然', '公文写作强'],
    cons: ['仅限中文', '长文生成一般'],
  },
  {
    id: '63', name: 'Copy.ai', slug: 'copy-ai',
    description: 'AI营销文案生成平台，社媒内容、广告文案、邮件营销一键生成，营销人必备。',
    longDescription: 'Copy.ai 是专业的AI营销文案生成平台，支持社交媒体内容、广告文案、营销邮件等多种场景的文案创作。内置丰富的模板和风格选项，帮助营销团队大幅提升内容生产效率。',
    category: 'writing', tags: ['营销', '文案', '广告', '社媒'],
    url: 'https://www.copy.ai',
    pricing: 'freemium', rating: 4.2, reviewCount: 4800, featured: false, hot: false, isNew: false,
    publishedAt: '2025-01-25',
    pros: ['模板丰富', '营销场景覆盖全', '上手简单'],
    cons: ['中文一般', '创意性有限'],
  },
  {
    id: '64', name: 'Notion AI', slug: 'notion-writing',
    description: 'Notion内置AI写作助手，笔记、文档、项目管理一站式AI增强，知识工作者首选。',
    longDescription: 'Notion AI 深度集成在Notion笔记和项目管理工具中，支持AI摘要生成、大纲创建、内容翻译和写作辅助。对于已经在使用Notion的团队来说，是最自然的AI写作增强方案。',
    category: 'writing', tags: ['写作', '笔记', '项目管理', '协作'],
    url: 'https://www.notion.so',
    pricing: 'freemium', rating: 4.6, reviewCount: 13500, featured: false, hot: false, isNew: false,
    publishedAt: '2025-01-05',
    pros: ['与Notion深度整合', '多场景覆盖', '协作方便'],
    cons: ['需Notion付费', '独立写作功能不如专用工具'],
  },

  // ===== AI音频 - 新增 =====
  {
    id: '65', name: 'Murf AI', slug: 'murf',
    description: 'AI语音合成平台，120+种语言声音，视频配音、广告旁白、有声书制作首选。',
    longDescription: 'Murf AI 是专业的AI语音合成平台，提供120多种语言和声音选择。生成的语音自然流畅，广泛应用于视频配音、广告旁白、有声书制作和企业培训等场景。',
    category: 'audio', tags: ['语音合成', '配音', '多语言'],
    url: 'https://murf.ai',
    pricing: 'freemium', rating: 4.3, reviewCount: 2800, featured: false, hot: false, isNew: false,
    publishedAt: '2025-01-28',
    pros: ['声音种类多', '音质自然', '操作简单'],
    cons: ['中文声音有限', '高质量需付费'],
  },

  // ===== 效率工具 - 新增 =====
  {
    id: '66', name: 'Gamma', slug: 'gamma-prod',
    description: 'AI一键生成精美PPT，输入主题自动生成幻灯片，告别手动排版，职场汇报神器。',
    longDescription: 'Gamma 是AI驱动的演示文稿生成工具，输入主题或大纲即可自动生成设计精美的PPT。内置丰富模板和AI排版引擎，支持文字、图片、图表等多种内容类型。',
    category: 'productivity', tags: ['PPT', '演示', '办公', '自动化'],
    url: 'https://gamma.app',
    pricing: 'freemium', rating: 4.4, reviewCount: 3600, featured: false, hot: true, isNew: true,
    publishedAt: '2025-02-18',
    pros: ['一键生成PPT', '模板精美', '操作简单'],
  ...
  {
    id: '67', name: 'Otter.ai', slug: 'otter',
    description: 'AI会议记录工具，实时转录会议内容，自动生成摘要和待办事项，远程办公必备。',
    longDescription: 'Otter.ai 是专业的AI会议记录和转录工具，支持实时会议转录、自动生成摘要和提取待办事项。与Zoom、Google Meet等主流会议平台深度集成，是远程办公的必备工具。',
    category: 'productivity', tags: ['会议', '转录', '办公', '协作'],
    url: 'https://otter.ai',
    pricing: 'freemium', rating: 4.3, reviewCount: 4200, featured: false, hot: false, isNew: false,
    publishedAt: '2025-01-30',
    pros: ['实时转录准确', '会议集成好', '摘要生成快'],
    cons: ['中文支持弱', '免费版时长有限'],
  },
  {
    id: '68', name: 'Perplexity AI', slug: 'perplexity-prod',
    description: 'AI搜索引擎，实时联网搜索+AI总结，每条答案附来源引用，研究调研必备。',
    longDescription: 'Perplexity AI 是革命性的AI搜索引擎，将大语言模型与实时网络搜索深度融合。每条回答都附带精准的来源引用，支持学术研究、市场调研等场景。',
    category: 'productivity', tags: ['搜索', '调研', 'AI搜索', '实时信息'],
    url: 'https://www.perplexity.ai',
    pricing: 'freemium', rating: 4.6, reviewCount: 4500, featured: false, hot: true, isNew: false,
    publishedAt: '2025-01-12',
    pros: ['实时搜索准确', '来源透明', '学术研究友好'],
    cons: ['深度分析不如ChatGPT', '专业版较贵'],
  },
];
